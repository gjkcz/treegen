...
Usecka::Usecka(D3DXMATRIX& pocatek, D3DXVECTOR3& x, D3DXVECTOR3& y, t::Barva barva, LPDIRECT3DDEVICE9* _pzarizeni) :  Tvar(pocatek, barva, _pzarizeni)
{
    cstmvtxVrcholy = nullptr;
    bufferVrcholu = nullptr;
    bufferIndicii = nullptr;
...
Usecka::Usecka(D3DXMATRIX& pocatek, D3DXVECTOR3& x, D3DXVECTOR3& y, t::Barva barva, LPDIRECT3DDEVICE9* _pzarizeni, float zRot) : Tvar(pocatek, barva, _pzarizeni, zRot)
{
    cstmvtxVrcholy = nullptr;
    bufferVrcholu = nullptr;
    bufferIndicii = nullptr;
